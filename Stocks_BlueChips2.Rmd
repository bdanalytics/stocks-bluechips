...
title: "Stocks:Infochimps: StockPrice regression:: BlueChips2"
author: "bdanalytics"
...
Source: 
    Training:   
        https://courses.edx.org/asset-v1:MITx+15.071x_2a+2T2015+type@asset+block/BoeingStock.csv
        https://courses.edx.org/asset-v1:MITx+15.071x_2a+2T2015+type@asset+block/CocaColaStock.csv
        https://courses.edx.org/asset-v1:MITx+15.071x_2a+2T2015+type@asset+block/GEStock.csv
        https://courses.edx.org/asset-v1:MITx+15.071x_2a+2T2015+type@asset+block/IBMStock.csv
        https://courses.edx.org/asset-v1:MITx+15.071x_2a+2T2015+type@asset+block/ProcterGambleStock.csv
    New:        <newdt_url>  
Time period: 
...
glb_trnng_url <- "https://courses.edx.org/asset-v1:MITx+15.071x_2a+2T2015+type@asset+block/IBMStock.csv"
glb_newdt_url <- "<newdt_url>"
glb_out_pfx <- "BlueChips2_"
...
glb_id_var <- NULL # or c("<col_name>")
glb_category_vars <- c("Symbol")
glb_date_vars <- c("Date")
glb_date_fmts <- list(); glb_date_fmts[["Date"]] <- "%m/%e/%y"
glb_date_tzs <- list();  glb_date_tzs[["Date"]] <- "America/New_York"
...
glb_exclude_vars_as_features <- union(glb_exclude_vars_as_features, 
                                      c("Date.year.fctr")) # or c("<col_name>")
...
tmp_allobs_df <- dplyr::select(glb_allobs_df, -Date.zoo)
symbol <- "GE"; print(symbol)
symbol <- "CocaCola"; print(symbol)
tapply(filter(tmp_allobs_df, Symbol == symbol)$StockPrice, 
       filter(tmp_allobs_df, Symbol == symbol)$Date.month, mean) / 
    mean(filter(tmp_allobs_df, Symbol == symbol)$StockPrice)
